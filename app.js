...
let userData = {
    stars: localStorage.getItem('stars') ? parseInt(localStorage.getItem('stars')) : 5000,
...
console.log('MP3 support:', canPlayAudio('audio/mpeg'));
console.log('OGG support:', canPlayAudio('audio/ogg; codecs="vorbis"'));

// Инициализация звуков с обработкой ошибок
...
// Обработчики ошибок
[bgMusic, spinSound, winSound].forEach(audio => {
    audio.addEventListener('error', (e) => {
        console.error('Audio error:', e.target.src, 
                     e.target.error.code, e.target.error.message);
    });
});
...
const cases = {
    "Обычный": {
        price: 100,
        items: [
            { name: "Norm 1", image: "https://i.yapx.ru/aGMLa.png", probability: 0.5 },
            { name: "Norm 2", image: "https://i.yapx.ru/aGMei.png", probability: 0.3 },
            { name: "Rare", image: "https://i.yapx.ru/aGMe1.png", probability: 0.15 },
            { name: "Epic", image: "https://i.yapx.ru/aGMe8.png", probability: 0.05 }
        ]
    },
    "Редкий": {
        price: 250,
        items: [
            { name: "Rare 1", image: "https://i.yapx.ru/aGMfO.png", probability: 0.6 },
            { name: "Rare 2", image: "https://i.yapx.ru/aGMfS.png", probability: 0.25 },
            { name: "Epic", image: "https://i.yapx.ru/aGMff.png", probability: 0.1 },
            { name: "Legenda", image: "https://i.yapx.ru/aGMgI.png", probability: 0.05 }
        ]
    },
    "Эпический": {
        price: 500,
        items: [
            { name: "Epic 1", image: "https://i.yapx.ru/aGMaI.png", probability: 0.55 },
            { name: "Epic 2", image: "https://i.yapx.ru/aGMcn.png", probability: 0.3 },
            { name: "Legenda", image: "https://i.yapx.ru/aGMfO.png", probability: 0.1 },
            { name: "Mifical", image: "https://i.yapx.ru/aGMe8.png", probability: 0.05 }
        ]
    },
    "Легендарный": {
        price: 1000,
        items: [
            { name: "Legenda 1", image: "https://i.yapx.ru/aGMfO.png", probability: 0.6 },
            { name: "Legenda 2", image: "https://i.yapx.ru/aGMe8.png", probability: 0.25 },
            { name: "Mifical", image: "https://i.yapx.ru/aGMgI.png", probability: 0.1 },
            { name: "Unic", image: "https://i.yapx.ru/aGMLa.png", probability: 0.05 }
        ]
    },
    "Мифический": {
        price: 2500,
        items: [
            { name: "Mifical 1", image: "https://i.yapx.ru/aGMe8.png", probability: 0.5 },
            { name: "Mifical 2", image: "https://i.yapx.ru/aGMfO.png", probability: 0.3 },
            { name: "Unic", image: "https://i.yapx.ru/aGMLa.png", probability: 0.15 },
            { name: "Immor", image: "https://i.yapx.ru/aGMe1.png", probability: 0.05 }
        ]
    }
};
